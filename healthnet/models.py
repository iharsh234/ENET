...
class MedicalInfo(models.Model):
    ...
    @staticmethod
    def to_vision(key):
        for item in MedicalInfo.VISION:
            if item[0] == key:
                return item[1]
        return "None"
    ...
    @staticmethod
    def to_patching(key):
        for item in MedicalInfo.PATCHING:
            if item[0] == key:
                return item[1]
        return "None"

    @staticmethod
    def to_compliance(key):
        for item in MedicalInfo.DO:
            if item[0] == key:
                return item[1]
        return "None"
    ...
    patching = models.CharField(max_length=10,choices=PATCHING)
    compliance = models.CharField(max_length=10,choices=DO)
...
class MedicalTest(models.Model):
    ...
    name = models.CharField(max_length=10, choices=TESTS)
    date = models.DateField()
...
class Score(models.Model):
    ...
    def owner_name(self):
        return self.owner.profile.firstname + " " + self.owner.profile.lastname
